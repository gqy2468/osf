...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${request.contextPath}/css/bootstrap2.css">
  	...
  	<link rel="stylesheet" type="text/css" href="${request.contextPath}/css/jquery.fullPage.css">
  	<link rel="stylesheet" type="text/css" href="${request.contextPath}/css/welcome.css">
	<style>
	.section1 { background: url("${request.contextPath}/img/background.png") no-repeat; background-size: cover;}
	.section4 { background: url("${request.contextPath}/img/gallery/8.jpg") no-repeat;
				background-size: cover;}
	</style>
  	<script src="${request.contextPath}/js/jquery.js"></script>
  	<script src="${request.contextPath}/js/jquery.fullPage.js"></script>
	...
	<div id="welcome">
		...
		<div class="section section1">
			...
			<div class="pulldown_tip">
				<img src="${request.contextPath}/img/pulldown_tip.png" alt="向下滑动">
			</div>
		</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="span6 offset3">
						<div class="row">
							<a class="login_btn span3" href="/account/login">登录</a>
							<a class="register_btn span3" href="/account/register">注册</a>						
						</div>
