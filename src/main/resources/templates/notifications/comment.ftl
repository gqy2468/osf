		...
		<div class="row">
			<div class="span4">
				<div class="ui vertical menu">
				  <a class="active teal item" href="/notifications/comment">
				  	评论
						    	...
						    	<div class="item">
								    ...
								    <div class="content">
								    	<a class="header" href="/user/${notification.notifier }">${notification.notifierName }</a>
								      	<#if object_link?exists>
								      	<div class="description">
								      		<#if notification.notifyType == dic.notify_type_comment>评论了你的</#if>
								      		<#if notification.notifyType == dic.notify_type_comment_reply>回复了你在</#if>
								      		<a href="${object_link}" >
								      			<b>
								      		...
								      		<#if notification.notifyType == dic.notify_type_comment_reply>的评论</#if>
								      		${notification.ts?datetime }
								      	</div>
										</#if>
								    </div>
						    	</div>
