...
<title>个人信息</title>
	...
	<script type="text/javascript" src="${request.contextPath}/js/setting.js"></script>
</head>
<body>
	<#include "../../topbar.ftl">
	<div class="container">
		<div class="row">
			<div class="span4">
				<div class="ui vertical menu">
				  <a class="active teal item" href="/account/setting/info">
				    个人信息
				  </a>
				  <a class="item" href="/account/setting/avatar">
				    头像
				  </a>
			...
			<div class="span8">
				...
				<div class="ui divider">
					...
					<div class="ui form setting info">
					    ...
					    <div class="inline disabled field">
					      <label>签名</label>
					      <textarea id="user_desc" plcaeholder="">${user.userDesc?default("") }</textarea>
					    </div>
