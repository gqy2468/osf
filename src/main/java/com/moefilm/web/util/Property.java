...
public class Property {
	...
	public static String SYNTH_URL;

	public static String DOMAIN_URL;

	public static String ACTIVATE_CONTEXT = DOMAIN_URL + "account/activation/";

	public static String RESETPWD_CONTEXT = DOMAIN_URL + "account/resetpwd/";
	...
	@Value("${post_cover_thumbnail}")
	public void setPostCoverThumbnail(String postCoverThumbnail) {
		POST_COVER_THUMBNAIL = postCoverThumbnail;
	}
	...
	@Value("${synthetize_url}")
	public void setSynthUrl(String synthUrl) {
		SYNTH_URL = synthUrl;
	}
	...
	public static final String ERROR_ALBUM_CREATE = "006000";				//创建相册错误
	...
	public static final String ERROR_ALBUM_TRANSFORM = "006004";				//转换相册图片错误
	public static final String ERROR_ALBUM_RESTORE= "006005";				//还原相册图片错误
	...
	public static final String ERROR_PHOTO_UPLOAD = "007003";
	...
	public static final String ERROR_MEDIA_EMPTY = "015000";
	public static final String ERROR_MEDIA_PERMISSIONDENIED = "015001";
	public static final String ERROR_MEDIA_PROCESSING = "015002";
	public static final String ERROR_MEDIA_SETTING_EMPTY = "015003";
	public static final String ERROR_MEDIA_SETTING_SAVE = "015004";
	public static final String ERROR_MEDIA_SAVE = "115005";
	
	public static final String ERROR_VIDEO_CREATE = "017000";
	public static final String ERROR_VIDEO_EMPTY = "017001";
	public static final String ERROR_VIDEO_UPDATE = "017002";
	public static final String ERROR_VIDEO_UPLOAD = "017003";
	
	public static final String ERROR_AUDIO_CREATE = "018000";
	public static final String ERROR_AUDIO_EMPTY = "018001";
	public static final String ERROR_AUDIO_UPDATE = "018002";
	public static final String ERROR_AUDIO_UPLOAD = "018003";
	public static final String ERROR_AUDIO_SYNTH = "018004";
	...
	public static final String SUCCESS_ALBUM_DELETE = "106003";
	...
	public static final String SUCCESS_MEDIA_SAVE = "115000";
	public static final String SUCCESS_MEDIA_DELETE = "115001";
	public static final String SUCCESS_MEDIA_SETTING = "115002";
	
	public static final String SUCCESS_FEED_DELETE = "116000";
	
	public static final String SUCCESS_VIDEO_CREATE = "117000";
	public static final String SUCCESS_VIDEO_UPDATE = "117001";
	public static final String SUCCESS_VIDEO_DELETE = "117002";
	public static final String SUCCESS_VIDEO_UPLOAD = "117003";
	
	public static final String SUCCESS_AUDIO_CREATE = "118000";
	public static final String SUCCESS_AUDIO_UPDATE = "118001";
	public static final String SUCCESS_AUDIO_DELETE = "118002";
	public static final String SUCCESS_AUDIO_UPLOAD = "118003";
	public static final String SUCCESS_AUDIO_SYNTH = "118004";
}
